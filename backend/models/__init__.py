"""ORM models matching the spec's table list: Companies, News, Sanctions, Cyber Findings,
Domains, Financial Metrics, ESG Scores, Risk History, Alerts, Users, Audit Logs."""
