"""
Generates realistic mock data standing in for OpenCorporates, OpenSanctions, NewsAPI,
Shodan, Yahoo Finance, MSCI ESG, Whois, VirusTotal, etc.

Swap any function here for a real API call later — the return shape is what the rest
of the app depends on, so keep it stable.
"""
import random
