...
Given a risk score breakdown, produces a natural-language explanation, e.g.:
  "XYZ Corporation presents elevated risk due to recent lawsuits and exposed
   services. Enhanced due diligence is recommended."

If ANTHROPIC_API_KEY is set in the environment, this calls the real Claude API.
Otherwise it falls back to a deterministic template generator so the app works
fully offline with mock data.
"""
import os
import json
