"""Daily scheduled jobs: fetch_news, fetch_shodan, update_sanctions, calculate_scores,
send_alerts. In mock mode these regenerate sample data; swap the body of each
`fetch_*` function for a real API client later."""
import logging
