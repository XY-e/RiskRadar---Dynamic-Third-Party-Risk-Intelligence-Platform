...
risk_score = 0.30*compliance + 0.20*cyber + 0.15*news + 0.15*financial
           + 0.10*esg + 0.05*domain + 0.05*social

All sub-scores are normalized to 0-100, where HIGHER = RISKIER.
"""
